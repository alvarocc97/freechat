            ...
            <div class="row">
                <div class="col s12 perfilCont white">
                    ...
                    if(isset($_SESSION["dniProfesional"])) {
                            ...
                            <form action="configuracion.php" method="post" enctype="multipart/form-data" class="col s12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s12 m6">
                                        ...
                                        <input type="password" id="clave2Prof" name="clave2Prof" maxlength="50" title="Vuelve a introducir tu contraseña" disabled>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-field col s12 m6">
                        ...
                        ?>
                        <img src="<?php echo $resultadoUsuario['imagen']; ?>" class="circle imgPerfil">
                        <div class="row formCont">
                            <form action="configuracion.php" method="post" enctype="multipart/form-data" class="col s12">
                                <div class="row">
                                    <div class="input-field col s12 m6 push-m3">
                                        ...
                                        <input type="text" id="nombreUsuario" name="nombreUsuario" value="<?php echo $resultadoUsuario['nombre']; ?>" maxlength="50" title="Tu nombre de usuario no puede ser editado por motivos de seguridad" readonly required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-field col s12 m6 push-m3">
                                        ...
                                        <input type="password" id="claveUsuario" name="claveUsuario" maxlength="50" title="Puedes editar aquí tu contraseña, si no rellenas este campo no se modificará">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-field col s12 m6 push-m3">
                                        <i class="material-icons prefix">enhanced_encryption</i>
                                        <label for="clave2Usuario">Vuelve a introducir la contraseña</label>
                                        <input type="password" id="clave2Usuario" name="clave2Usuario" maxlength="50" title="Vuelve a introducir tu contraseña" disabled>
                                    </div>
                                </div>
                                <div class="row">
                                    <fieldset class="col s12 m6 push-m3">
